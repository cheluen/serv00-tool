...
```bash
# frp 主菜单功能
./serv00-tool.sh -> "5. 🌐 frp 内网穿透"

# 📥 安装 frps 服务端    - 一键安装配置
# 🎛️ frps 服务管理      - 启动/停止/重启/日志/配置
# 📱 创建 frp 客户端     - 快速创建客户端应用
# 📊 frp 状态总览       - 查看服务端和客户端状态
# 📖 frp 使用指南       - 详细使用说明
```
...
```
serv00-tool/
├── serv00-tool.sh          # 🎯 唯一主脚本（2000+ 行，包含所有功能）
├── README.md               # 📖 完整文档
└── LICENSE                 # 📄 许可证
